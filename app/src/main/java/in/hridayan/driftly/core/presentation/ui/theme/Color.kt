...
fun expressiveLightColorSchemeFromSeed(): ColorScheme {
    return lightColorScheme(
        primary = 40.a1,
        primaryContainer = 90.a1,
        onPrimary = 100.a1,
        ...
        surfaceDim = 87.n1,
        surfaceBright = 98.n1,
        surfaceContainerLowest = 96.n1,
        surfaceContainerLow = 92.n1,
        surfaceContainer = 90.n1,
        surfaceContainerHigh = 88.n1,
        surfaceContainerHighest = 86.n1,
        inverseSurface = 20.n1,
        inverseOnSurface = 95.n1,
...
fun expressiveDarkColorSchemeFromSeed(): ColorScheme {
    return darkColorScheme(
        primary = 80.a1,
        primaryContainer = 30.a1,
        onPrimary = 15.a1,
